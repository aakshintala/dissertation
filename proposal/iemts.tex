...
tells us that GPUvm~\cite{suzuki2014gpuvm} will have bad performance because it
relies on trapping and emulating the guest's MMIO accesses. These are really
\aak{What is the takeaway? Does this framework really make a difference?}