...
Table~\ref{tab:new-dims} presents analysis of three prior GPU virtualization systems under the \texttt{IEMTS} framework. \aak{What is the takeaway? Does this framework really make a difference?}