...
% The \Trillium design uses LLVM IR as the common virtual ISA for GPGPU
% applications, where necessary: OpenCL code is compiled to PTX using the LLVM
% NVPTX back-end in the guest, and then finalized and executed in the host using
% the NVIDIA CUDA framework.